...
<section id="cart_items">
		<div class="container">
			...
			<form method="POST" action="{{URL::to('/place-order')}}">
				{{ csrf_field() }}
				<div class="payment-options">
					<input type="submit" value="Thanh toán tiền mặt"  name="payment_method" class="btn btn-success btn-lg" style="margin-left: 25px">

				...
				<div class="col-sm-6">
					<div class="total_area">
						...
						<?php
								...
								?>
								<a class="btn btn-default check_out" style="margin-left: 40px" href="{{URL::to('/show-checkout')}}">Thanh Toán </a>
								<?php
								}elseif($id != NULL && $shipping_id != NULL){
								?>
								<a class="btn btn-default check_out" style="margin-left: 40px" href="{{URL::to('/payment')}}">Thanh Toán </a>
								<?php
								}else{
								?>
								<a class="btn btn-default check_out" style="margin-left: 40px" href="{{URL::to('/user-register')}}">Thanh Toán </a>
								<?php
								}
								?>
					</div>
